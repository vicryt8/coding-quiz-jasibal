...
var questions = [
    ...
    {
        title: "Which of the following is not a coding term:",
        choices: ["API", "DOM", "JSON Derulo", "JQuery"],
        answer: "JSON Derulo",
        respectOrder: false,
    },
    {
    ...
    {
        title: "An object must be enclosed in:",
        choices: ["quotes", "curly brackets", "parentheses", "square brackets"],
        answer: "curly brackets",
        respectOrder: false,
    },
    {
        title: "Which of the following is used for arrays:",
        choices: ["quotes", "curly brackets", "parentheses", "square brackets"],
    ...
    },
    {
        ...
        choices: ["Linux", "iOS", "Windows", "none of the above"],
        answer: "none of the above",
        respectOrder: true,
    },
    {
        title: "Which of these is not a programming event:",
        choices: ["onclick", "onkeydown", "onload", "ongoing"],
        answer: "ongoing",
        respectOrder: false,
    },
    {
        title: "Which of the following is not related to JavaScript:",
        choices: ["Java", "TypeScript", "JQuery", "CSS"],
        answer: "Java",
        respectOrder: false,
    },
];
...
document.addEventListener("keydown", (event) => keyboardClick(event));
